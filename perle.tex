...
% set PDF metadata
\hypersetup{%
pdftitle={Experimental investigation of Newton's second law using a two-mass pulley system},
pdfauthor={Andrew Fox, Brandon Heller, Dev Parekh, Joshua Perle, and Clay Stevens},
}
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[RE,RO]{J S\&E \textbf{1}, 27--29 (2024)}
\fancyhead[LO]{Perle et al.}
\fancyhead[LE]{Experimental investigation of Newton's second law}
\fancyfoot[C]{\thepage}
\fancypagestyle{mytitlepage}{
\fancyhf{}
\fancyhead[C]{Journal of Science \& Engineering \textbf{1}, 27--29 (2024)}
\fancyfoot[C]{\thepage}
}
